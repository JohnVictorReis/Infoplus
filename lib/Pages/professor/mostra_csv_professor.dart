...
/*//versão otimizada será feita abaixo
  ...
  Future<void> _deleteData(String documentId) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Documento excluído com sucesso!")));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Erro ao excluir o documento.")));
    }
  }
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: Text(
                    'Aluno: ${doc['aluno']}, Atividade: ${doc['atividade']}, Nota: ${doc['nota']}'),
                // Adiciona o ícone de exclusão
                trailing: IconButton(
                  icon: Icon(Icons.delete),
                  onPressed: () {
                    _confirmDelete(
                        doc.id); // Chama a função de confirmação de exclusão
                  },
                ),
              );
            },
